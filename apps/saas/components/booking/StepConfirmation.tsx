...
export function StepConfirmation({ state, tenant, returnUrl }: StepConfirmationProps) {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-12 md:py-20 text-center">
      ...
      <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
        ...
        {returnUrl ? (
          <a href={returnUrl} className="inline-flex items-center justify-center rounded-full px-8 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 text-sm font-medium">
