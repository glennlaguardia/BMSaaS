...
// ---- Component ----
export function DayTourWizard({ tenant, addons, returnUrl }: DayTourWizardProps) {
  // Step state
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="flex items-center justify-between mb-10">
        {returnUrl ? (
          ...
          <span className="text-sm text-forest-500/60 flex items-center gap-1.5 font-medium">
            <ArrowLeft className="w-4 h-4" />
            {tenant.name}
          </span>
        )}
